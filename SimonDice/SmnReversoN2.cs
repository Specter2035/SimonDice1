...
namespace SimonDice
{
    public partial class SmnReversoN2 : Form
    {
        ...
        private void btnIniciar_Click(object sender, EventArgs e)
        {
            ...
            GenerarSecuencia(10);//se genera una nueva secuancia de 10 colores siempre
        ...
        {    //si el juego esta hablando o si la lista de simon esta vacia no hace nada 
            ...
            {
                MessageBox.Show("Tu puntaje final es:" + (puntos * 2));//te muestra tu puntaje final
