...
namespace SimonDice
{
    public partial class SmnReversoN3 : Form
    {
        ...
        private void btnIniciar_Click(object sender, EventArgs e)
        {
            ...
            GenerarSecuencia(15);//se genera una nueva secuancia de 15 colores siempre
        ...
        {    //si el juego esta hablando o si la lista de simon esta vacia no hace nada 
            ...
            else
            {
                ...
                MessageBox.Show("Tu puntaje final es:" + (puntos * 3));//te muestra tu puntaje final
            ...
            lblPumtos.Text = (puntos * 3).ToString();
        }
        private void P_0_Click_1(object sender, EventArgs e)
        {
